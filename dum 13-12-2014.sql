...
INSERT INTO `deduccioness_emp` VALUES (1,4,1,200,1),(2,4,1,500,1),(3,2,1,1000,1),(4,3,1,750,1),(7,9,3,1000,1);
...
INSERT INTO `dependientes` VALUES (2,5,'Maria','Contreras','44422220364','conyuge'),(3,5,'Maria','Contreras','44422220364','conyuge'),(4,5,'Maria','Contreras','44422220364','conyuge'),(5,8,'Juanny','Gutierrez','','hijo'),(6,9,'Fanny','Maria','','abuela'),(7,10,'sss','sssss','','abuela');
...
INSERT INTO `empleado_admin` VALUES (2,'2010-03-02',1,1,1,1),(3,'2008-05-01',1,1,1,1),(4,'2014-12-11',1,1,1,1),(5,'2014-12-11',1,4,1,1),(6,'2014-12-11',1,4,1,1),(7,'2014-12-11',1,4,1,1),(8,'2011-12-01',1,4,1,2),(9,'2014-12-11',1,2,1,1),(10,'2014-12-12',2,6,1,1);
...
INSERT INTO `ingresos_emp` VALUES (1,3,1,500),(3,5,1,250),(4,6,2,5000),(5,5,6,1500),(6,9,2,5000),(7,9,3,15000);
...
INSERT INTO `tipos_descuentos` VALUES (1,'Deduccion 1'),(3,'Sobregiro de tarjeta');
...
INSERT INTO `tipos_ingresos` VALUES (1,'Ingreso 1'),(2,'HORAS_EXTRAS'),(3,'Farmacia'),(6,'Gasolina');
...
-- Dump completed on 2014-12-13 16:42:39
